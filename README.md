...
La carte de Manaus, pour acceder à cette carte :
  ...
  3. Ensuite cliquer sur page build and Deployement
  4. Il ya un lien qui va s'afficher en bas de deploy, cliquer sur le lien et enfin la carte va s'afficher
